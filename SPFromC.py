import numpy as np
#Function taken from https://www.teos-10.org/pubs/gsw/html/gsw_SP_from_C.html using the pss-78 algorithm, stipped down only to include
#SP from C,t,p calculation.
...
def SP_from_C(C, t, p):
    ...
    t : array
        in-situ temperature [:math:`degrees` C (ITS-90)]
    p : array
        sea pressure [dbar]
